...
for video in tqdm(uni_videos):
    ...
    ############################################
    #j, f = 0, frame[0]
    copyfolder = cfg.results_path+'/magnification/generated_only3/%s/'%(video)
    perimage_folder= cfg.results_path+'/magnification/magnification_pervideo3/%s/'%(video)
    ...
    for f, fr in enumerate(tqdm(frame)):
        ...
        _=imsave(generatedonly+'%d.png'%(fr),impaired_res)
