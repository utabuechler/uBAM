...
# Form implementation generated from reading ui file 'GUI/SimilarityMagnification/design3.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_magnification_th = QtWidgets.QLabel(self.Frame_nrNN)
        self.label_magnification_th.setObjectName("label_magnification_th")
        self.verticalLayout_2.addWidget(self.label_magnification_th)
        self.doubleSpinBox_magnification_th = QtWidgets.QDoubleSpinBox(self.Frame_nrNN)
        self.doubleSpinBox_magnification_th.setEnabled(False)
        self.doubleSpinBox_magnification_th.setSingleStep(0.01)
        self.doubleSpinBox_magnification_th.setProperty("value", 0.2)
        self.doubleSpinBox_magnification_th.setObjectName("doubleSpinBox_magnification_th")
        self.verticalLayout_2.addWidget(self.doubleSpinBox_magnification_th)
...
"border-width: 10")
        ...
        spacerItem1 = QtWidgets.QSpacerItem(42, 20, QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem3 = QtWidgets.QSpacerItem(21, 20, QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem4 = QtWidgets.QSpacerItem(20, 350, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        ...
        spacerItem5 = QtWidgets.QSpacerItem(20, 487, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        ...
        spacerItem7 = QtWidgets.QSpacerItem(20, 100, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Maximum)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Label_chooseMethod.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">4. Choose Method</span></p></body></html>"))
        ...
        self.ComboBox_compute.setItemText(2, _translate("MainWindow", "Magnification"))
        self.Label_NN.setText(_translate("MainWindow", "<html><head/><body><p>#Nearest Neighbors</p></body></html>"))
        self.label_magnification_th.setText(_translate("MainWindow", "Deviation threshold"))
